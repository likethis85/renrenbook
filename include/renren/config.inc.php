...
$config->CALLBACK = 'http://renrenbook.sinaapp.com/index.php?c=auth&a=come_from_renren'; //回调地址，注意和您申请的应用一致

$config->APIURL		= 'http://api.renren.com/restserver.do'; //RenRen网的API调用地址，不需要修改
$config->APIKey		= '48eb87f804144adcbcdbda23a887889f';	//你的API Key，请自行申请
$config->SecretKey	= '3d7b03479a5f46fcb71951e3bc33e086';	//你的API 密钥
$config->APIVersion	= '1.0';	//当前API的版本号，不需要修改
$config->decodeFormat	= 'json';	//默认的返回格式，根据实际情况修改，支持：json,xml
$config->scope = "read_user_status read_user_blog read_user_comment";
/*
...
$config->APIMapping		= array( 
		...
		*/
		'status.gets'=>'page,count',
		'status.getComment'=>'status_id,owner_id,page,count',
		'blog.gets'=>'uid,page,count',
		'blog.get'=>'id',
		'friends.getFriends'=>'page,count'
